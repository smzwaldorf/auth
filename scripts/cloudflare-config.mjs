...
if (new Set(Object.values(vars).map(value => new URL(value).origin)).size !== Object.keys(vars).length) throw new Error("Auth, App A and App B require distinct origins");
