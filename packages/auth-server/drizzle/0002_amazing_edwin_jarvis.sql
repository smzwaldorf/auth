...
--> statement-breakpoint
ALTER TABLE "auth"."oauth_access_token" ALTER COLUMN "token" DROP NOT NULL;--> statement-breakpoint
ALTER TABLE "auth"."oauth_access_token" ALTER COLUMN "expires_at" DROP NOT NULL;--> statement-breakpoint
ALTER TABLE "auth"."oauth_access_token" ALTER COLUMN "created_at" DROP NOT NULL;--> statement-breakpoint
ALTER TABLE "auth"."oauth_consent" ALTER COLUMN "created_at" DROP NOT NULL;--> statement-breakpoint
ALTER TABLE "auth"."oauth_consent" ALTER COLUMN "updated_at" DROP NOT NULL;--> statement-breakpoint
ALTER TABLE "auth"."oauth_refresh_token" ALTER COLUMN "expires_at" DROP NOT NULL;--> statement-breakpoint
ALTER TABLE "auth"."oauth_refresh_token" ALTER COLUMN "created_at" DROP NOT NULL;--> statement-breakpoint
...
ALTER TABLE "auth"."oauth_access_token" ADD COLUMN "revoked" timestamp;--> statement-breakpoint
...
ALTER TABLE "auth"."oauth_client" ADD COLUMN "client_credentials_scopes" text[] DEFAULT '{}';--> statement-breakpoint
...
ALTER TABLE "auth"."oauth_client" ADD COLUMN "dpop_bound_access_tokens" boolean DEFAULT false;--> statement-breakpoint
...
ALTER TABLE "auth"."oauth_refresh_token" ADD COLUMN "rotated_at" timestamp;--> statement-breakpoint
ALTER TABLE "auth"."oauth_refresh_token" ADD COLUMN "rotation_replay_response" text;--> statement-breakpoint
ALTER TABLE "auth"."oauth_refresh_token" ADD COLUMN "rotation_replay_expires_at" timestamp;--> statement-breakpoint
...
CREATE UNIQUE INDEX "oauthClientResource_clientId_resourceId_unique" ON "auth"."oauth_client_resource" USING btree ("client_id","resource_id");--> statement-breakpoint
...
CREATE INDEX "oauthRefreshToken_authorizationCodeId_idx" ON "auth"."oauth_refresh_token" USING btree ("authorization_code_id");