...
import { authOrigin, authPort, config, directoryAudience, trustedClientIds } from "./config.js";
...
const server = serve({ fetch: app.fetch, hostname: "127.0.0.1", port: authPort }, () => {
