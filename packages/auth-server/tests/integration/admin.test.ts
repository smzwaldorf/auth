...
import { people, personRoles, user, loginInvitations, session, auditEvents, applications, oauthClient, appAccess, oauthAccessToken, oauthRefreshToken } from "../../src/db/schema.js";
